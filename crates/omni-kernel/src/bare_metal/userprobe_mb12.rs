...
pub const USERPROBE_SENDER_ELF: &[u8] = &[
    ...
    // mov rdi, 1 (channel_id)
    0x48, 0xc7, 0xc7, 0x01, 0x00, 0x00, 0x00,
    // mov rsi, 3 (kind = Notification)
    0x48, 0xc7, 0xc6, 0x03, 0x00, 0x00, 0x00,
    // lea rdx, [rip+0x1B] (→ "ping")
    0x48, 0x8d, 0x15, 0x1b, 0x00, 0x00, 0x00,
    // mov r10, 4 (payload_len)
    0x49, 0xc7, 0xc2, 0x04, 0x00, 0x00, 0x00,
    // syscall
    0x0f, 0x05,
    // mov rax, 11 (TaskExit)
...
pub const USERPROBE_RECEIVER_ELF: &[u8] = &[
    ...
    // mov r10, 1 (blocking = true)
    0x49, 0xc7, 0xc2, 0x01, 0x00, 0x00, 0x00,
    // syscall — rax = bytes_received
    0x0f, 0x05,
    // mov r11, rax
    0x49, 0x89, 0xc3,
    // mov rax, 60 (WriteConsole)
    0x48, 0xc7, 0xc0, 0x3c, 0x00, 0x00, 0x00,
    // lea rdi, [rip+0x17] (→ buf)
