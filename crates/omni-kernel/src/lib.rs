...
pub fn kmain(boot_info: &'static bootloader::bootinfo::BootInfo) -> ! {
    ...
    vga::write_at(6, 30, env!("CARGO_PKG_VERSION").as_bytes(), vga::LIGHT_CYAN, vga::BLACK);
    ...
    vga::write_at( 9, 33, env!("CARGO_PKG_VERSION").as_bytes(), vga::WHITE, vga::BLACK);

    vga::write_at(10, 4, b"Boot mode:", vga::LIGHT_CYAN, vga::BLACK);
    vga::write_at(10, 20, b"BIOS / bootloader v0.9 (SeaBIOS)", vga::WHITE, vga::BLACK);
