...
- [x] **P6.2 — UEFI bootloader (decision: Limine vs Tock vs custom)** (closed 2026-05-17: `OIP-Kernel-003` `Active` via §5.5 Solo Founder Fast-Track — 48h Last Call window 2026-05-15→2026-05-17, no blocking objections, founder ballot 1/1 in favour; K5 audit at `docs/audits/qemu-boot-smoke-2026-05.md`)
