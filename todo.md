...
| MB14.c.2.c | Live INIT-SIPI-SIPI fire + AP landing stub + ack barrier + `kmain_ap` higher-half park entry + PIT delays | `[x]` (chiuso 2026-05-19) | (this commit) | [ADR-0007](docs/adr/0007-mb14-mp-ap-startup.md) |
| MB14 | MP/AP enable + TLB shootdown cross-AS (Phase 1.5) | `[~]` (MB14.a + MB14.b + MB14.c.1 + MB14.c.2.a + MB14.c.2.b.1 + MB14.c.2.b.2 + MB14.c.2.c chiusi; MB14.c.2.d-f open) | — | — |
