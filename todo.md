...
| MB14.e | `sti` su AP idle park + per-CPU run-queue scaffold (`per_cpu_run_queue` con `MAX_CPUS` slot, SpinLock, work-stealing back-of-lowest-priority) + boot-log smoke | `[x]` (chiuso 2026-05-19) | (this commit) | — |
| MB14 | MP/AP enable + TLB shootdown cross-AS (Phase 1.5) | `[~]` (MB14.a + MB14.b + MB14.c.* + MB14.d + MB14.e chiusi; MB14.f open) | — | — |
