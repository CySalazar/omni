...
| MB14.c.2.b.2 | Bare-metal emplacement (alloc 3 frames + materialize temp PML4/PDPT/PD + identity-map trampoline page in active CR3 + copia blob a `0x8000`) | `[x]` (chiuso 2026-05-19) | (this commit) | — |
| MB14 | MP/AP enable + TLB shootdown cross-AS (Phase 1.5) | `[~]` (MB14.a + MB14.b + MB14.c.1 + MB14.c.2.a + MB14.c.2.b.1 + MB14.c.2.b.2 chiusi; MB14.c.2.c-f open) | — | — |
