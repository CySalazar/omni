...
| MB14.f | AP LAPIC enable (`kernel_ap_lapic_init` SIVR+TPR+timer) + x2APIC awareness (mode detect + MSR primitives + 32-bit LAPIC ID via CPUID leaf 0xB) + ADR-0008; chiude MB14.e.4 follow-up | `[x]` (chiuso 2026-05-20) | (this commit) | [ADR-0008](docs/adr/0008-mb14f-per-cpu-scheduling-protocol.md) |
| MB14 | MP/AP enable + TLB shootdown cross-AS (Phase 1.5) | `[~]` (MB14.a + MB14.b + MB14.c.* + MB14.d + MB14.e + MB14.f chiusi; MB14.g open) | — | — |
