...
| MB14.d | TLB shootdown IPI vector `0xFD` + `ipi::send_to_all_except_self` + `mm::flush_tlb_range` + 0xFD ISR (descriptor with VA range + ack counter + generation) | `[x]` (chiuso 2026-05-19) | (this commit) | — |
| MB14 | MP/AP enable + TLB shootdown cross-AS (Phase 1.5) | `[~]` (MB14.a + MB14.b + MB14.c.* + MB14.d chiusi; MB14.e-f open) | — | — |
