...
| MB14.f | AP LAPIC enable (`kernel_ap_lapic_init`) + x2APIC awareness (mode detect + MSR primitives + 32-bit LAPIC ID) + per-AP periodic timer + ADR-0008 — chiude MB14.e.4 | ✅ | (this commit) |
