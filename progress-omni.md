...
| MB14.e | `sti` su AP idle park + per-CPU run-queue scaffold (`per_cpu_run_queue` con `MAX_CPUS` slot, SpinLock, work-stealing) + boot-log smoke | ✅ | (this commit) |
