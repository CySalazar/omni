...
| 002 | Process | Bug Bounty Program for OMNI OS | Active *(closed 2026-05-22 by §5.3 ¶1 ballot)* | cySalazar | 2026-05-10 |
...
| 018 | Standards Track | Filesystem direction for OMNI OS — native OmniFS as primary, foreign filesystems as read-only compatibility services | Active *(closed 2026-05-22 by §5.3 ¶1 ballot)* | cySalazar | 2026-05-22 |
